"""
Formatting support for PyCents.

The :mod:`pycents.formatting` module provides the default formatting
...
See :py:meth:`pycents.money.Money.__format__` for a complete
description of the format spec language.

pycents supports different local aware backend formatters.
...
* Formatting at :mod:`~pycents.formatting` package level:
