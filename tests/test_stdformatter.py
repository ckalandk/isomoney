...
class TestStdFormatter:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("name", Decimal("1234.56"), "1,234.56\xa0US Dollar"),
        ],
    )
    ...
    def test_compact_notation_positive(self, std_formatter, amount, expected):
        ...
        result = std_formatter.format(amount, "USD", spec)
        assert result == expected
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (Decimal("-2500000"), "name", "(2.5M\xa0US Dollar)"),
        ],
    )
    ...
    def test_group_separator(self, std_formatter, group_sep, expected):
        ctx = FormatSpec(group_separator=group_sep, ccy_display="hidden")
